...
Para  iniciar  la  aplicacion  ,desde un editor de codigo , ubicarse en las carpetas /api y /front  ,ejecutar  primero  'npm i' y luego 'npm start' , luego abrir un navegador  y ir a la pagina http://localhost:3000/ y ahi aparecera la aplicacion 
